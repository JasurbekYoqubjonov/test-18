...
const VideoDetail=()=>{
  ...
  return (
    <Box minHeight={"90vh"} mb={10} sx={{marginTop:2}}>
      <Box display={"flex"} sx={{flexDirection:{xs:"column", md:"row"}}}>
        <Box width={{xs:"100%",md:"75%"}} sx={{xs:{marginLeft:"0", md:{marginLeft:"20px"}}}}>
          ...
          <Link to={`/channel/${videoDetail?.snippet?.channelId}`} style={{textDecoration:"none", color:"black"}}>
